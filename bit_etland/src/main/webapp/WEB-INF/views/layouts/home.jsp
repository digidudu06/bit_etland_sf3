...
<head>
  ...
  <link href="resources/assets/css/sequence.css" rel="stylesheet">
...
<body>
  <header>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="index.html"><img src="resources/assets/img/logo.png" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
              ...
              <div id="sequence">
                <ul>
                  ...
                  <li>
                    ...
                    <img class="slider_img animate-in" src="resources/assets/img/slides/sequence/img-1.png" alt="">
                  </li>
                  <!-- Layer 2 -->
                  <li>
                    <div class="info">
                    ...
                    <img class="slider_img" src="resources/assets/img/slides/sequence/img-2.png" alt="">
                  </li>
                  <!-- Layer 3 -->
                  <li>
                    <div class="info">
                    ...
                    <img class="slider_img" src="resources/assets/img/slides/sequence/img-3.png" alt="">
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="home-posts">
          ...
          <div class="span3">
            <div class="post-image">
              <a href="post_right_sidebar.html">
					<img src="resources/assets/img/dummies/blog1.jpg" alt="">
					</a>
            </div>
          ...
          <div class="span3">
            <div class="post-image">
              <a href="#"><img src="resources/assets/img/dummies/blog2.jpg" alt=""></a>
            </div>
            <div class="entry-meta">
              <a href="#"><i class="icon-square icon-48 icon-pencil left"></i></a>
          ...
          <div class="span3">
            <div class="post-slider">
              ...
              <div class="flexslider">
                <ul class="slides">
                  <li>
                    <a href="post_right_sidebar.html"><img src="resources/assets/img/dummies/work1.jpg" alt=""></a>
                  </li>
                  <li>
                    <a href="post_right_sidebar.html"><img src="resources/assets/img/dummies/work2.jpg" alt=""></a>
                  </li>
                  <li>
                    <a href="post_right_sidebar.html"><img src="resources/assets/img/dummies/work3.jpg" alt=""></a>
                  </li>
                </ul>
              </div>
              <!-- end flexslider -->
 ...
 ================================================== -->
        ...
        <div class="span4">
          <div class="widget">
            ...
            <a class="brand logo" href="index.html">
							<img src="resources/assets/img/logo-dark.png" alt="">
						</a>
            <!-- end logo -->
            <address>
  ...
  <script src="resources/assets/js/sequence/sequence.jquery-min.js"></script>
  <script src="resources/assets/js/sequence/setting.js"></script>
  ...
  <script src="resources/assets/js/hover/jquery-hover-effect.js"></script>
  <script src="resources/assets/js/hover/setting.js"></script>
