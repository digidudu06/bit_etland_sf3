...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h5><span id="res_btn_1" class="label label-danger">Food</span> <span id="res_btn_2" class="label label-primary">Ipsum</span></h5><br>
